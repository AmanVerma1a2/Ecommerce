...
<input onChange={(e)=>setImage4(e.target.files[0])} type='file' id="image4" hidden />
  ...
  <div className='w-full'>
    ...
    <textarea onChange={(e)=>setDescription(e.target.value)}  className='w-full max-[500px] px-3 py-2'type="text" placeholder='Write content here' required />
  </div>
  <div>
...
<option value="Winterwear">Winterwear</option>
  ...
  <div>
    ...
    <button type="submit" className='w-28 py-3 mt-4 bg-green-500 text-white'>ADD</button>
  </div>
    </div>
  </form>
  )
